...
def snippet_4():
    ...
    # d is false because both boolean statements are false therefore no valid statement can be confirmed rendering the whole equation false.
...
def snippet_5():
    ...
    print (f"The value of o ({o}) is True since lower case goat is greater than upper case GOAT.")
